...
<body>
	...
	<div class="mt-150 mb-150">
		<div class="container">
			<div class="row">
				<?php 
					$id_danhmuc_bv = $_GET['id_dmbv'];
					$query_bv = mysqli_query($conn,
						"SELECT * FROM baiviet_sp,danhmucbaiviet_sp WHERE baiviet_sp.id_danhmuc_bv = '$id_danhmuc_bv' LIMIT 1"
					);
				...
				<div class="col-lg-8">
					<div class="single-article-section">
						<div class="single-article-text">
							<div class="single-artcile-bg"><img src="admin/anh/<?php echo $row_bv['anh_bv'] ?>" alt=""></div>
							<p class="blog-meta">
								...
								<?php if ($row_bv['nguon_bv']){ ?>
									<span>Nguồn bài viết <?php echo $row_bv['nguon_bv'] ?></span>
								<?php } ?>
							</p>
							<h2><?php echo $row_bv['ten_bv'] ?></h2>
							<p><?php echo $row_bv['noidung_bv'] ?></p>
						</div>
						<?php } ?>
					</div>
				</div>
				<?php 
					$query_bv_bv = mysqli_query($conn,
						"SELECT * FROM baiviet_sp,danhmucbaiviet_sp WHERE baiviet_sp.id_danhmuc_bv = danhmucbaiviet_sp.id_danhmuc_bv"
					);
					$row_bv_bv=mysqli_fetch_array($query_bv_bv);
				 ?>
				<div class="col-lg-4">
					<div class="sidebar-section">
						<div class="recent-posts">
							...
							<ul>
								<li><a href="baiviet.php?id_dmbv=<?php echo $row_bv_bv['id_danhmuc_bv'] ?>"><?php echo $row_bv_bv['ten_bv'] ?></a></li>
						...
						<div class="archive-posts">
							<h4>Lưu trữ</h4>
							<ul>
								<li><a href="#"><?php echo $row_bv_bv['ngaytao_bv'] ?></a></li>
							</ul>
						</div>
