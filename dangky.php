	...
	<?php 
		if (isset($_POST['dangky'])) {
    		...
    		$query_kh = mysqli_query($conn,
    			"INSERT INTO dangky_sp(ten_kh,sodienthoai_kh,email_kh,matkhau_kh,diachi_kh,hinhanh_kh)
    			VALUES('$ten_kh','$sodienthoai_kh','$email_kh','$matkhau_kh','$diachi_kh','$hinhanh_kh')
    			");
    		if ($query_kh) {
    		...
    		echo'<script>alert("Bạn đã đăng ký tài khoản thành công!!!"),location="dangnhap.php";</script>';
		...
		<div class="container">
			<div class="row">
				<div class="section-title" data-aos="fade-up" data-aos-duration="1500">
					<h2 data-title="Đăng ký">Tài khoản</h2>
				</div>
			</div>
				<form action="dangky.php" method="post" enctype="multipart/form-data">
					<div class="dangky-items row">
						<div class="dangky-item">
							<div class="dangky-item-text">
								<label for="">Họ và tên: </label>
								<input type="text" name="ten_kh" placeholder="Nhập họ và tên">
							</div>
							<div class="dangky-item-text">
								<label for="">Số điện thoại: </label>
								<input type="text" name="sodienthoai_kh" placeholder="Nhập số điện thoại">
							</div>
							<div class="dangky-item-text">
							...
							<div class="dangky-item-text">
								...
								<textarea name="diachi_kh" id="" cols="30" rows="10"  placeholder="Nhập địa chỉ"></textarea>
							</div>
							<div class="dangky-item-text">
								<label for="">Chọn ảnh:</label>
								<input type="file" name="hinhanh_kh">
							</div>
							<div class="dangky-item-text-1">
