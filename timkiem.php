					...
					<div class="search-bar">
						<div class="search-bar-tablecell">
							...
							<form action="timkiem.php">
								...
								<button type="submit" name="timkiem">Tìm <i class="fas fa-search"></i></button>
							</form>
						</div>
					</div>
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="section-title" data-aos="fade-up" data-aos-duration="1500">
					<h2 data-title="Danh sách">Sản phẩm tìm kiếm</h2>
				</div>
			</div>
			<div class="row product-product">
				<!--------------- côt 1------------ -->
				<div class="product-item-catagory">
						<div class="product-item-catagory-title">
							<p>Danh mục sản phẩm</p>
						</div>
						<div class="product-item-catagorys">
							<?php 
							$query_dm = mysqli_query($conn,"SELECT * FROM danhmuc_sanpham");
							while($row_dm = mysqli_fetch_array($query_dm)){
							 ?>
					...
					<!-- ----------------------------------------------------------------------------- -->
						...
						<div class="product-item-catagorys">
							...
							<div class="product-catagory-item">
								<div class="product-catagory-item-text">
									<a href=""><span><?php echo $row_dmbv['ten_danhmuc_bv'] ?></span></a>
								</div>
							</div>
							<?php } ?>
				...
				<div class="product-items">
					<?php 
						...
						$query_sp = mysqli_query($conn,
						 "SELECT * FROM sanpham_sp,danhmuc_sanpham WHERE sanpham_sp.id_danhmuc = danhmuc_sanpham.id_danhmuc AND sanpham_sp.ten_sp LIKE '%$tukhoa%'"
						);
					...
					<form action="themgiohang.php?id_sp=<?php echo $row_sp['id_sp']?>&id_dm=<?php echo $row_sp['id_danhmuc']?> " method="post">
						<div class="product-item">
							...
							<div class="product-item-text">
								<h2><a href="chitietsanpham.php?id_sp=<?php echo $row_sp['id_sp']?>"><?php echo $row_sp['ten_sp'] ?></a></h2>
								<p style="color: red;"><?php echo number_format($row_sp['gia_sp'],0,'.','.')."VNĐ" ?></p>
								<p><?php echo $row_sp['tendanhmuc'] ?></p>
