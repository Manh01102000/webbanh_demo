                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_array($query)) { ?>
                                <tr>
                                    ...
                                    <td style=""><?php echo md5($row['user_pass']);?></td>
                                    <td style=""><img style="width: 100px;" src="anh/<?php echo $row['image_us'] ?>" alt=""></td>
                                    <td><span class="label label-<?php if($row['user_level']==1){echo "danger";}else{echo 'success';}?>"><?php if($row['user_level']==1){echo 'Quản Lý';}else{echo 'Nhân viên';}?></span></td>
                                    <td class="form-group">
                                        ...
                                        <a href="del_user.php?id=<?php echo $row['user_id'];?>" onclick="return confirm('Bạn thực sự muốn xóa')" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
                                    </td>
                                </tr>
                            <?php }
                            ?>
